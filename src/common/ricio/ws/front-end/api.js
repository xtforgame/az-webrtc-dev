...
export default class WsProtocolApi extends ApiBase {
  ...
  request(msgConfig, timeout = 30000) {
    return this.sendAndWaitResponse(msgConfig, timeout);
  }

  sendAndWaitResponse(msgConfig, timeout = 30000) {
    ...
    return new Promise((resolve, reject) => {
      this.waitResPromises[msgId] = { resolve, reject, expTime: new Date().getTime() + timeout };
